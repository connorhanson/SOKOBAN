...
public class TestSokoban {
    ...
    public static void testInitBoard() {
        ...
        if (!compBoards(bTest1, bCompTest1)) {
            System.out.println("FAILED: Sokoban.initBoard Test 1. Board not as expected!"); // if
                                                                                            // board
                                                                                            // does
            // not generate expected result
        ...
        if (!compBoards(bTest2, bCompTest2)) {
            ...
            System.out.println("Generated:");
            Sokoban.printBoard(bTest2); // same as above
            System.out.println("Expected:");
        ...
        if (!compBoards(bTest3, bCompTest3)) {
            ...
            System.out.println("Generated:");
            Sokoban.printBoard(bTest3); // same as above tests
            System.out.println("Expected:");
    ...
    /**
     * This method tests the Sokoban.calcDelta method based on different input values and prints out
     * number of tests passed out of total number of tests.
     */
    ...
    /**
     * This method tests the Sokoban.togglePos method based on different input values and prints out
     * number of tests passed out of total number of tests.
     */
    ...
    /**
     * This method tests the Sokoban.shiftBox method based on different input values and prints out
     * number of tests passed out of total number of tests.
     */
    ...
    /**
     * This method tests the Sokoban.doMove method based on different input values and prints out
     * number of tests passed out of total number of tests.
     */
